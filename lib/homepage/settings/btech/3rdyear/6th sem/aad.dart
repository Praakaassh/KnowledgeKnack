...
class AlgorithmAnalysisPage extends StatefulWidget {
  const AlgorithmAnalysisPage({super.key});

  @override
  _AlgorithmAnalysisPageState createState() => _AlgorithmAnalysisPageState();
}

class _AlgorithmAnalysisPageState extends State<AlgorithmAnalysisPage>
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Algorithm Analysis materials are being prepared',
                        style: TextStyle(
                          fontSize: 16,
