...
class IeftPage extends StatefulWidget {
  const IeftPage({super.key});

  @override
  _IeftPageState createState() => _IeftPageState();
}

class _IeftPageState extends State<IeftPage> with SingleTickerProviderStateMixin {
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'IEFT materials are being prepared',
                        style: TextStyle(
                          fontSize: 16,
