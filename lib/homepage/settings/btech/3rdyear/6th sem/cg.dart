...
class ComputerGraphicsPage extends StatefulWidget {
  const ComputerGraphicsPage({super.key});

  @override
  _ComputerGraphicsPageState createState() => _ComputerGraphicsPageState();
}

class _ComputerGraphicsPageState extends State<ComputerGraphicsPage> with SingleTickerProviderStateMixin {
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Computer Graphics materials are being prepared',
                        style: TextStyle(
                          fontSize: 16,
