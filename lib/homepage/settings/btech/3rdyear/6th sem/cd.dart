...
class CompilerDesignPage extends StatefulWidget {
  const CompilerDesignPage({super.key});

  @override
  _CompilerDesignPageState createState() => _CompilerDesignPageState();
}

class _CompilerDesignPageState extends State<CompilerDesignPage> with SingleTickerProviderStateMixin {
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Compiler Design materials are being prepared',
                        style: TextStyle(
                          fontSize: 16,
