...
class DataAndComputerCommunicationPage extends StatefulWidget {
  const DataAndComputerCommunicationPage({super.key});

  @override
  _DataAndComputerCommunicationPageState createState() => _DataAndComputerCommunicationPageState();
}

class _DataAndComputerCommunicationPageState extends State<DataAndComputerCommunicationPage> with SingleTickerProviderStateMixin {
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'DCC materials are being prepared',
                        style: TextStyle(
                          fontSize: 16,
